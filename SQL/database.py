...
datosMangas = [
    ('ONE-ODA', 'One Piece', 'One Piece es un manga japonés escrito e ilustrado por Eiichirō Oda. Comenzó a publicarse en la revista Weekly Shōnen Jump el 22 de julio de 1997.', 'Aventura, Acción, Comedia, Drama, Fantasía', 'Eiichirō Oda', 'Resources/Manga/OP.jpg', 98, 1000, json.dumps([('M-One Piece-prueba','prueba@gmail.com','Demasiado largo','2025-03-10')])),
    ...
    ('DRA-AKI', 'Dragon Ball', 'Dragon Ball es un manga japonés escrito e ilustrado por Akira Toriyama. Comenzó a publicarse en la revista Weekly Shōnen Jump el 3 de diciembre de 1984.', 'Aventura, Acción, Comedia, Drama, Fantasía', 'Akira Toriyama', 'Resources/Manga/DBZ.jpg', 42, 520, json.dumps([('M-Dragon Ball-prueba','prueba@gmail.com','Super es la mejor saga','2025-03-10')])),
